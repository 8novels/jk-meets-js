...
「さてさて。この変数の宣言において重要なのが、『スコープ』という概念よ。すなわち、その宣言がどこまでの範囲で通用するのか、ということ」
...
「……まだ続くの？　私の謂《いわ》れなき疑惑」
「そろそろ受け入れなさい。で、このコードを実行すると『fujoshi』という文字列が出力されるわ」
...
「あ、インデントには全角スペースを使用しておりますのでお気をつけください」
「誰に向かって言ってんの？」
